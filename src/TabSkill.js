...
const TabSkill = () =>{
    return(
        <div className="tab-skill" id='skill-tab'>
            ...
            <section className='tab-skill-card'>
                <img src={c} alt='skill' className='tab-skill-card-image'/>
                <h3>C</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={cPlus} alt='skill' className='tab-skill-card-image'/>
                <h3>C++</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={css} alt='skill' className='tab-skill-card-image'/>
                <h3>CSS</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={firebase} alt='skill' className='tab-skill-card-image'/>
                <h3>FireBase</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={git} alt='skill' className='tab-skill-card-image'/>
                <h3>GitHub</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={html5} alt='skill' className='tab-skill-card-image'/>
                <h3>HTML5</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={java} alt='skill' className='tab-skill-card-image'/>
                <h3>JAVA</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={js} alt='skill' className='tab-skill-card-image'/>
                <h3>JavaScript</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={sql} alt='skill' className='tab-skill-card-image-1'/>
                <h3>MySQL</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={node} alt='skill' className='tab-skill-card-image-1'/>
                <h3>NodeJS</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={php} alt='skill' className='tab-skill-card-image-2'/>
                <h3>PHP</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={post} alt='skill' className='tab-skill-card-image-3'/>
                <h3>PostgreSQL</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={python} alt='skill' className='tab-skill-card-image-4'/>
                <h3>Python</h3>
            </section>
            <section className='tab-skill-card'>
                <img src={react} alt='skill' className='tab-skill-card-image-5'/>
                <h3>ReactJS</h3>
            </section>
            </div>
        </div>
